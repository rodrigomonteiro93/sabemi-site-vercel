...
const FATURA_MOCK: FaturaData = {
  id: '5069',
  geradaEm: '25/01/2026 às 06:00',
    ...
    },
    {
      icon: (
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <path d="M14.5 9a2.5 2.5 0 0 0-5 0c0 1.5 2.5 2.5 2.5 3.5"/>
...
const COMISSOES_MOCK: FaturaComissaoItem[] = [
  {
    id: '25299',
...
export default function FaturaDetalhePage({ params }: PageProps) {
  const fatura = { ...FATURA_MOCK, id: params.id };
  return <FaturaDetalheContent fatura={fatura} comissoes={COMISSOES_MOCK} />;
}
