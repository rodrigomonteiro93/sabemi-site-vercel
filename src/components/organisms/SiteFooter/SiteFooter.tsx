      ...
      <div className="container">
        <div className={styles.footGrid}>
          ...
          <div className={styles.footBrand}>
            ...
            <a href="#" className={styles.maps}>ABRIR ENDEREÇO NO GOOGLE MAPS</a>
          ...
          <div className={styles.footCol}>
            <h4>Parceiros</h4>
            <ul>
              <li><a href="#">EU VIAJO SEGURO</a></li>
          ...
          <div className={styles.footCol}>
            <h4>Links Úteis</h4>
            <ul>
              <li><a href="#">Alterar / Cancelar o Seguro</a></li>
              <li><a href="#">Dicas de como utilizar o seguro</a></li>
              <li><a href="#">Entenda as coberturas</a></li>
              <li><a href="#">O que é Seguro Viagem — Diferenças de Assistência e Seguro</a></li>
              <li><a href="#">Perguntas e Respostas</a></li>
              <li><a href="#">Países que Exigem Cobertura de Seguro de Viagem</a></li>
